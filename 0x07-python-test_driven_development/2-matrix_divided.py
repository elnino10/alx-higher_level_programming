#!/usr/bin/python3
"""the matrix_divided function receives a matrix("matrix") as its first argument and
 a number("div") as the second argument. The elements of "matrix" are divided by "div"
...
def matrix_divided(matrix, div):
    ...
    if not (isinstance(matrix, list) and all(isinstance(
